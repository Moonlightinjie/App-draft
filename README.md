# THE SIMPLER SOLAR CALCULATOR

A Streamlit app that estimates solar panel needs using simple user inputs.
...
-Python 3.8 or higher, Pip (python package manager), web browser 
